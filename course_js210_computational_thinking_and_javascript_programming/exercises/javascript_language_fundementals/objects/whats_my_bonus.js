...
The functions makes use of the local arguments variable that is accessible to functions (except arrow fucntions).
The variable is assigned an array-like (not an array!) object that contains all arguments passed to the function -
even though we didn't define any. We can then access those arguments by index.
*/