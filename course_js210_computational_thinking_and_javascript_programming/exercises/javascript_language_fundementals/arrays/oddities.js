...
The equal operator will only return true when comparing two arrays if it's the same object in memory - i.e. they are referring to excactly the same object.

In both cases we are comparing new arrays to the array.
*/