...
// Note that the message property uses the result of concatenation as its value. As a result, we have two global variables: name, and greeting that pollute the global scope.
...
var greeter = {
  message: (function () { // Here we preprocess some values without poluting the namespace
    name = 'Naveed';
    greeting = 'Hello';
...
/*
 * This is a pattern that can be very useful when we want to some sort of preprocessing, where we need to introduce additional variables.
 */
