/*
For this exercise set, we will be working with the DDL statements to create and modify tables in a database that tracks planets around stars other than our Sun.
...
-- create two tables (once connected to the database)
CREATE TABLE stars (
