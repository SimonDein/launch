...
# and returns a symbol :right, :acute, :obtuse, or :invalid depending on whether the triangle is a right,
...
def triangle(a, b, c)
  sides = [a, b, c]
  return :invalid if sides.sum != 180 || sides.include?(0)
  return :obtuse if sides.max > 90
